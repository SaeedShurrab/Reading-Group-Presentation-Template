...
% uncomment and add if you need more
...
% copy/paste/uncomment to add new slide
% \end{frame}

%------------------------------------------------

% the following slides are for formatting purposes. include to your presentation body what you need and uncomment these slides upon finishing.   
